  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center p-4 bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100">
      <div className="w-full max-w-md space-y-6 bg-white dark:bg-slate-900 p-8 rounded-2xl shadow-xl border border-slate-200 dark:border-slate-800 text-center">
        ...
        <h1 className="text-2xl font-extrabold text-slate-900 dark:text-white">403 - Access Forbidden</h1>

        <p className="text-sm text-slate-600 dark:text-slate-400">
          Your hospital role (<span className="font-bold capitalize text-rose-600 dark:text-rose-400">{user?.role || 'Guest'}</span>) does not have sufficient security privileges to access this module or operational resource.
        </p>
